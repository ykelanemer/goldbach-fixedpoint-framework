...
$6 \le k \le 97$ & Intermediate Islands ($p_2 \le \sqrt{2N}$) & \textbf{Conditionally Eliminated / Frontier} & Proposition~\ref{prop:large_islands_squeeze}, \ref{prop:inductive_contraction} \\ \bottomrule
\end{tabular}%
}
...
\item \textbf{Reduction to the Finite Asymptotic Frontier ($6 \le k \le 97$):}  
